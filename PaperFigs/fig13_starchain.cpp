...
int main()
{
  ...
  // Estimate sizes:
  cout << "<Rg2>=" << GiNaC::latex << w.RadiusOfGyration2("chain") << endl;
  cout << "<R_center_to_all>=" << GiNaC::latex << w.SMSD_ref2scat("chain:star3:diblock1:A.end1") << endl;
  cout << "<R2_length>="  << GiNaC::latex << w.SMSD_ref2ref("chain:star1:diblock1:B.end2","chain:star5:diblock3:B.end2") << endl;
  cout << "<R2_breath>="  << GiNaC::latex << w.SMSD_ref2ref("chain:star3:diblock2:B.end2","chain:star3:diblock4:B.end2") << endl;
}
