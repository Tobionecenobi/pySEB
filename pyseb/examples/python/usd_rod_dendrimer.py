"""Export a four-generation rod dendrimer with contour-linked branches."""
import pyseb


world = pyseb.World("rod_dendrimer")
...
world.export_usd("dendrimer", "rod_dendrimer.usda", parameters, options)
